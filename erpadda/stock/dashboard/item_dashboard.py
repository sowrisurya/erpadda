...
def get_data(item_code=None, warehouse=None, item_group=None,
	...
	items = vmraid.db.get_all('Bin', fields=['item_code', 'warehouse', 'projected_qty',
	...
	for item in items:
		item.update({
			'item_name': vmraid.get_cached_value(
				"Item", item.item_code, 'item_name'),
			'disable_quick_entry': vmraid.get_cached_value(
				"Item", item.item_code, 'has_batch_no')
			or vmraid.get_cached_value(

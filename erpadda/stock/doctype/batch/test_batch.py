...
from erpadda.stock.doctype.batch.batch import get_batch_qty, UnableToSelectBatchError, get_batch_no
...
class TestBatch(unittest.TestCase):
	def test_item_has_batch_enabled(self):
		self.assertRaises(ValidationError, vmraid.get_doc({
			"doctype": "Batch",
			"name": "_test Batch",
			"item": "_Test Item"
		}).save)
	...
	def test_delivery_note(self):
		...
		delivery_note = vmraid.get_doc(dict(

...
from vmraid.utils import cint, nowdate, nowtime, cstr, add_days, flt, today
...
from erpadda.stock.doctype.delivery_note.delivery_note import make_sales_invoice, make_delivery_trip
from erpadda.stock.doctype.stock_entry.test_stock_entry \
	import make_stock_entry, make_serialized_item, get_qty_after_transaction
from erpadda.stock.doctype.serial_no.serial_no import get_serial_nos, SerialNoWarehouseError
from erpadda.stock.doctype.stock_reconciliation.test_stock_reconciliation \
	import create_stock_reconciliation, set_valuation_method
from erpadda.selling.doctype.sales_order.test_sales_order import make_sales_order, create_dn_against_so
...
class TestDeliveryNote(unittest.TestCase):
	...
	def test_delivery_note_no_gl_entry(self):
		...
		sle = vmraid.get_doc("Stock Ledger Entry", {"voucher_type": "Delivery Note", "voucher_no": dn.name})
	...
	def test_delivery_note_gl_entry_packing_item(self):
		...
		stock_value_diff_rm1 = abs(vmraid.db.get_value("Stock Ledger Entry",
			{"voucher_type": "Delivery Note", "voucher_no": dn.name, "item_code": "_Test Item"},
			"stock_value_difference"))

		stock_value_diff_rm2 = abs(vmraid.db.get_value("Stock Ledger Entry",
	...
	def test_sales_return_for_non_bundled_items_partial(self):
		...
		# outgoing_rate
		outgoing_rate = vmraid.db.get_value("Stock Ledger Entry", {"voucher_type": "Delivery Note",
		...
		gle_warehouse_amount = vmraid.db.get_value("GL Entry", {"voucher_type": "Delivery Note",
	...
	def test_delivery_of_bundled_items_to_target_warehouse(self):
		...
		stock_value_difference1 = vmraid.db.get_value("Stock Ledger Entry",
			{"voucher_type": "Delivery Note", "voucher_no": dn.name,
		...
		stock_value_difference = abs(vmraid.db.sql("""select sum(stock_value_difference)

// Copyright (c) 2015, VMRaid Technologies Pvt. Ltd. and Contributors // License: GNU General Public License v3. See license.txt
...
vmraid.ui.form.on('Stock Entry', {
	...
	calculate_amount: function(frm) {
		...
		if (in_list(["Repack", "Manufacture"], frm.doc.purpose)) {
			total_basic_amount = vmraid.utils.sum(
...
erpadda.stock.StockEntry = class StockEntry extends erpadda.stock.StockController {
	...
	scan_barcode() {
		let transaction_controller= new erpadda.TransactionController({frm:this.frm});

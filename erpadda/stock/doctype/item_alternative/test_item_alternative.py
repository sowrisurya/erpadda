...
from erpadda.buying.doctype.purchase_order.purchase_order import make_purchase_receipt, make_rm_stock_entry
import unittest
...
class TestItemAlternative(unittest.TestCase):
	...
	def test_alternative_item_for_subcontract_rm(self):
		...
		reserved_qty_for_sub_contract = vmraid.db.get_value('Bin',
		...
		doc.save()
		doc.submit()
		after_transfer_reserved_qty_for_sub_contract = vmraid.db.get_value('Bin',
			{'item_code': 'Test FG A RW 1', 'warehouse': '_Test Warehouse - _TC'}, 'reserved_qty_for_sub_contract')
	...
	def test_alternative_item_for_production_rm(self):
		...
		reserved_qty_for_production = vmraid.db.get_value('Bin',
		...
		ste.submit()
		reserved_qty_for_production_after_transfer = vmraid.db.get_value('Bin',
			{'item_code': 'Test FG A RW 1', 'warehouse': '_Test Warehouse - _TC'}, 'reserved_qty_for_production')
...
def make_items():
	...
	if not vmraid.db.get_value('BOM',

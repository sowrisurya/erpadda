...
def get_item_details(conditions):
	...
	for i in vmraid.db.sql("""select name, item_group, item_name, description,
...
def get_price_list():
	...
	price_list = vmraid.db.sql("""select ip.item_code, ip.buying, ip.selling,
...
def get_item_bom_rate():
	...
	for b in vmraid.db.sql("""select item, (total_cost/quantity) as bom_rate
...
def get_valuation_rate():
	...
	for d in vmraid.db.sql("""select item_code,

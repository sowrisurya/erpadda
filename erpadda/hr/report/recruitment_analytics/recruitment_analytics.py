...
def get_job_opening(sp_list):
	...
	job_openings = vmraid.get_all("Job Opening", filters = [["staffing_plan", "IN", sp_list]], fields =["name", "staffing_plan"])
...
def get_job_applicant(jo_list):
	...
	applicants = vmraid.get_all("Job Applicant", filters = [["job_title", "IN", jo_list]], fields =["name", "job_title","applicant_name", 'status'])
...
def get_job_offer(ja_list):
	...
	offers = vmraid.get_all("Job Offer", filters = [["job_applicant", "IN", ja_list]], fields =["name", "job_applicant", "status", 'offer_date', 'designation'])

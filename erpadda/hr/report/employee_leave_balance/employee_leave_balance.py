...
from erpadda.hr.doctype.leave_application.leave_application import get_leaves_for_period, get_leave_balance_on
...
def get_data(filters):
	...
	active_employees = vmraid.get_list('Employee',
		filters=conditions,
...
def get_department_leave_approver_map(department=None):
	...
	department_list = vmraid.db.sql_list(""" SELECT name FROM `tabDepartment` WHERE disabled=0 {0}""".format(conditions)) #nosec

	# retrieve approvers list from current department and from its subsequent child departments
	approver_list = vmraid.get_all('Department Approver', filters={

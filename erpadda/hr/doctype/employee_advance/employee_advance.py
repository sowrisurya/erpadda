...
class EmployeeAdvance(Document):
	...
	def set_total_advance_paid(self):
		...
		if flt(paid_amount) > self.advance_amount:
			vmraid.throw(_("Row {0}# Paid Amount cannot be greater than requested advance amount"),
		...
		self.set_status()
		vmraid.db.set_value("Employee Advance", self.name , "status", self.status)


	def update_claimed_amount(self):
		claimed_amount = vmraid.db.sql("""
...
def get_pending_amount(employee, posting_date):
	employee_due_amount = vmraid.get_all("Employee Advance", \

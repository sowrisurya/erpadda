...
import vmraid
import unittest
from erpadda.hr.doctype.leave_application.test_leave_application import get_leave_period, get_employee
...
class TestLeavePolicyAssignment(unittest.TestCase):
	...
	def setUp(self):
		for doctype in ["Leave Application", "Leave Allocation", "Leave Policy Assignment", "Leave Ledger Entry"]:
			vmraid.db.sql("delete from `tab{0}`".format(doctype)) #nosec
	...
	def test_grant_leaves(self):
		...
		leave_policy_assignment_doc = vmraid.get_doc("Leave Policy Assignment", leave_policy_assignments[0])
		...
		leave_allocation = vmraid.get_list("Leave Allocation", filters={

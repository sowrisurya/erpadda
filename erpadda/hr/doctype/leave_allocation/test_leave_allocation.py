...
import vmraid
import unittest
from vmraid.utils import nowdate, add_months, getdate, add_days
from erpadda.hr.doctype.leave_type.test_leave_type import create_leave_type
from erpadda.hr.doctype.leave_ledger_entry.leave_ledger_entry import process_expired_allocation, expire_allocation
...
class TestLeaveAllocation(unittest.TestCase):
	...
	def test_creation_of_leave_ledger_entry_on_submit(self):
		...
		leave_ledger_entry = vmraid.get_all('Leave Ledger Entry', fields='*', filters=dict(transaction_name=leave_allocation.name))
		...
		self.assertFalse(vmraid.db.exists("Leave Ledger Entry", {'transaction_name':leave_allocation.name}))

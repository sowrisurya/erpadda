...
def get_columns(based_on):
	return [
		{
			"fieldname": vmraid.scrub(based_on),
			"label": _(based_on),
			"fieldtype": "Data",
			"width": 150
		},
...
def get_order_amount(leads):
	return vmraid.db.sql("""select sum(base_net_amount)

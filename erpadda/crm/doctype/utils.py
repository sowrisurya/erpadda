...
def get_last_interaction(contact=None, lead=None):
	...
	if lead:
		last_communication = vmraid.get_all('Communication', filters={
...
def get_scheduled_employees_for_popup(communication_medium):
	...
	available_employee_groups = vmraid.get_all("Communication Medium Timeslot", filters={
		'day_of_week': weekday,
	...
	employees = vmraid.get_all('Employee Group Table', filters={

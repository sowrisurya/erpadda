...
vmraid.provide("erpadda_integrations.shopify_settings");

vmraid.ui.form.on("Shopify Settings", "onload", function(frm){
	vmraid.call({
		method:"erpadda.erpadda_integrations.doctype.shopify_settings.shopify_settings.get_series",
		callback:function(r){
	...
	erpadda_integrations.shopify_settings.setup_queries(frm);
})

vmraid.ui.form.on("Shopify Settings", "app_type", function(frm) {
	frm.toggle_reqd("api_key", (frm.doc.app_type == "Private"));
	frm.toggle_reqd("password", (frm.doc.app_type == "Private"));
})

vmraid.ui.form.on("Shopify Settings", "refresh", function(frm){
...
$.extend(erpadda_integrations.shopify_settings, {

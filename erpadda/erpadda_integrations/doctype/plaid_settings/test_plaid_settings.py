...
class TestPlaidSettings(unittest.TestCase):
	...
	def test_default_bank_account(self):
		...
		self.assertRaises(vmraid.ValidationError, add_bank_accounts, response=bank_accounts, bank=bank, company=company)
	...
	def test_new_transaction(self):
		...
		if vmraid.db.get_value("Company", company, "default_bank_account") is None:
			vmraid.db.set_value("Company", company, "default_bank_account", get_default_bank_cash_account(company, "Cash").get("account"))

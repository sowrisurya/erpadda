...
import vmraid
import unittest
from erpadda.erpadda_integrations.doctype.mpesa_settings.mpesa_settings import process_balance_info, verify_transaction
...
class TestMpesaSettings(unittest.TestCase):
	...
	def test_creation_of_payment_gateway(self):
		...
		mode_of_payment = vmraid.get_doc("Mode of Payment", "Mpesa-_Test")
	...
	def test_processing_of_callback_payload(self):
		...
		mpesa_account = vmraid.db.get_value("Payment Gateway Account", {"payment_gateway": 'Mpesa-Payment'}, "payment_account")
		...
		integration_req_ids = vmraid.get_all("Integration Request", filters={
	...
	def test_processing_of_only_one_succes_callback_payload(self):
		...
		pr = pos_invoice.create_payment_request()
		new_integration_req_ids = vmraid.get_all("Integration Request", filters={
			'reference_doctype': pr.doctype,
			'reference_docname': pr.name,

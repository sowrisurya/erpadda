...
def create_stripe_subscription(gateway_controller, data):
	...
	try:
		...
		stripe_settings.payment_plans = vmraid.get_doc("Payment Request", stripe_settings.data.reference_docname).subscription_plans
...
def create_subscription_on_stripe(stripe_settings):
		...
		for payment_plan in stripe_settings.payment_plans:
			plan = vmraid.db.get_value("Subscription Plan", payment_plan.plan, "payment_plan_id")

...
TAXJAR_CREATE_TRANSACTIONS = vmraid.db.get_single_value("TaxJar Settings", "taxjar_create_transactions")
...
def set_sales_tax(doc, method):
	...
	sales_tax_exempted = hasattr(doc, "exempt_from_sales_tax") and doc.exempt_from_sales_tax \
		or vmraid.db.has_column("Customer", "exempt_from_sales_tax") and vmraid.db.get_value("Customer", doc.customer, "exempt_from_sales_tax")

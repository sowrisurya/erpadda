...
def get_context(context):
	...
	if len(favorite_articles) < 6:
		...
		for record in (vmraid.get_all("Help Article", 
...
def get_help_article_list():
	...
	for category in category_list:
		help_articles = vmraid.get_all("Help Article", fields="*", filters={"category": category.name, "published": 1}, order_by="modified desc", limit=5)
		if help_articles:

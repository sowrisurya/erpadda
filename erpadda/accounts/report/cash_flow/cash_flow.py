...
from erpadda.accounts.report.financial_statements import (get_period_list, get_columns, get_data, get_filtered_list_for_consolidated_report)
...
def get_account_type_based_gl_data(company, start_date, end_date, account_type, filters={}):
	...
	if filters.include_default_book_entries:
		...
		cond = """ AND (finance_book in (%s, %s, '') OR finance_book IS NULL)
			""" %(vmraid.db.escape(filters.finance_book), vmraid.db.escape(company_fb))
	else:
		cond = " AND (finance_book in (%s, '') OR finance_book IS NULL)" %(vmraid.db.escape(cstr(filters.finance_book)))

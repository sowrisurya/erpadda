...
import vmraid
from vmraid.utils import getdate, add_days, today, cint
...
def get_items(filters):
	...
	items = vmraid.get_all("Item", fields=["name", "item_group", "item_name", "item_code"], filters=filters_dict, order_by="name")

...
def get_columns(invoice_list, additional_table_columns):
	...
	if invoice_list:
		expense_accounts = vmraid.db.sql_list("""select distinct expense_account
...
def get_invoice_po_pr_map(invoice_list):
	...
	for d in pi_items:
		if d.purchase_order:
			invoice_po_pr_map.setdefault(d.parent, vmraid._dict()).setdefault(
		...
		if d.purchase_receipt:
			...
			pr_list = vmraid.db.sql_list("""select distinct parent from `tabPurchase Receipt Item`
...
def get_account_details(invoice_list):
	...
	for acc in vmraid.db.sql("""select name, parent_account from tabAccount
...
def get_supplier_details(suppliers):
	supplier_details = {}
	for supp in vmraid.db.sql("""select name, supplier_group from `tabSupplier`

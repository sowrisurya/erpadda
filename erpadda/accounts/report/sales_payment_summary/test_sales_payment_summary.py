...
import unittest
import vmraid
from erpadda.accounts.report.sales_payment_summary.sales_payment_summary import get_mode_of_payments, get_mode_of_payment_details
...
class TestSalesPaymentSummary(unittest.TestCase):
	...
	def test_get_mode_of_payments(self):
		...
		payment_entries = vmraid.get_all("Payment Entry", filters={"mode_of_payment": "Cash", "docstatus": 1}, fields=["name", "docstatus"])
	...
	def test_get_mode_of_payments_details(self):
		...
		payment_entries = vmraid.get_all("Payment Entry", filters={"mode_of_payment": "Credit Card", "docstatus": 1}, fields=["name", "docstatus"])

...
from erpadda.selling.report.item_wise_sales_history.item_wise_sales_history import get_item_details, get_customer_details
...
def get_deducted_taxes():
	return vmraid.db.sql_list("select name from `tabPurchase Taxes and Charges` where add_deduct_tax = 'Deduct'")
...
def get_tax_accounts(item_list, columns, company_currency,
	...
	tax_amount_precision = get_field_precision(vmraid.get_meta(tax_doctype).get_field('tax_amount'),

...
from erpadda.accounts.doctype.sales_invoice.test_sales_invoice import create_sales_invoice, check_gl_entries
...
class TestProcessDeferredAccounting(unittest.TestCase):
	def test_creation_of_ledger_entry_on_submit(self):
		...
		process_deferred_accounting = doc = vmraid.get_doc(dict(

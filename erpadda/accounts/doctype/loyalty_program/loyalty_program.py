...
from vmraid.utils import today, flt
...
def get_loyalty_details(customer, loyalty_program, expiry_date=None, company=None, include_expired_entry=False):
	...
	loyalty_point_details = vmraid.db.sql('''select sum(loyalty_points) as loyalty_points,
...
def validate_loyalty_points(ref_doc, points_to_redeem):
	...
	if loyalty_program and vmraid.db.get_value("Loyalty Program", loyalty_program, ["company"]) !=\
		ref_doc.company:

...
class TestPOSProfile(unittest.TestCase):
	def test_pos_profile(self):
		...
		if pos_profile:
			...
			products_count = vmraid.db.sql(""" select count(name) from tabItem where item_group = '_Test Item Group'""", as_list=1)
			customers_count = vmraid.db.sql(""" select count(name) from tabCustomer where customer_group = '_Test Customer Group'""")
...
def get_customers_list(pos_profile={}):
	...
	return vmraid.db.sql(""" select name, customer_name, customer_group,

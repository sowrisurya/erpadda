...
class TestPOSInvoice(unittest.TestCase):
	...
	def test_serialized_item_transaction(self):
		...
		self.assertRaises(vmraid.ValidationError, pos2.insert)
	...
	def test_loyalty_points(self):
		...
		lpe = vmraid.get_doc('Loyalty Point Entry', {'invoice_type': 'POS Invoice', 'invoice': inv.name, 'customer': inv.customer})
	...
	def test_merging_into_sales_invoice_with_discount(self):
		...
		from erpadda.accounts.doctype.pos_invoice_merge_log.pos_invoice_merge_log import consolidate_pos_invoices
		...
		rounded_total = vmraid.db.get_value("Sales Invoice", pos_inv.consolidated_invoice, "rounded_total")
	...
	def test_merging_with_validate_selling_price(self):
		...
		rounded_total = vmraid.db.get_value("Sales Invoice", pos_inv2.consolidated_invoice, "rounded_total")

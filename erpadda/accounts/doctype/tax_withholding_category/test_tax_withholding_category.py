...
class TestTaxWithholdingCategory(unittest.TestCase):
	...
	def test_cumulative_threshold_tds(self):
		vmraid.db.set_value("Supplier", "Test TDS Supplier", "tax_withholding_category", "Cumulative Threshold TDS")
		invoices = []
	...
	def test_single_threshold_tds(self):
		invoices = []
		vmraid.db.set_value("Supplier", "Test TDS Supplier1", "tax_withholding_category", "Single Threshold TDS")
	...
	def test_cumulative_threshold_tcs(self):
		vmraid.db.set_value("Customer", "Test TCS Customer", "tax_withholding_category", "Cumulative Threshold TCS")
		invoices = []
...
def cancel_invoices():
	purchase_invoices = vmraid.get_all("Purchase Invoice", {
		'supplier': ['in', ['Test TDS Supplier', 'Test TDS Supplier1', 'Test TDS Supplier2']],
		'docstatus': 1
	}, pluck="name")

	sales_invoices = vmraid.get_all("Sales Invoice", {

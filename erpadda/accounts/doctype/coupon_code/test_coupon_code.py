...
def test_create_test_data():
	...
	item_price = vmraid.get_list('Item Price', filters={'item_code': '_Test Tesla Car', 'price_list': '_Test Price List'}, fields=['name'])
	if len(item_price)==0:
	...
	if not vmraid.db.exists("Pricing Rule","_Test Pricing Rule for _Test Item"):

...
import vmraid
import unittest
from vmraid.utils import nowdate, now_datetime
...
from erpadda.accounts.doctype.budget.budget import get_actual_expense, BudgetError
...
class TestBudget(unittest.TestCase):
	def test_monthly_budget_crossed_ignore(self):
		...
		self.assertTrue(vmraid.db.get_value("GL Entry",
	...
	def test_monthly_budget_crossed_stop1(self):
		...
		vmraid.db.set_value("Budget", budget.name, "action_if_accumulated_monthly_budget_exceeded", "Stop")
...
def make_budget(**args):
	...
	if budget_against == "Project":
		...
		budget_list = vmraid.get_all("Budget", fields=["name"], filters = {"name": ("like", cost_center_name)})

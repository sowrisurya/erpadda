			...
			for account_name, child in iteritems(children):
				...
				if account_name not in ["account_number", "account_type",
					...
					account = vmraid.get_doc({
						...
						"account_currency": child.get('account_currency') or vmraid.db.get_value('Company',  company,  "default_currency"),
...
def get_chart(chart_template, existing_company=None):
	...
	if existing_company:
		...
		from erpadda.accounts.doctype.account.chart_of_accounts.verified import standard_chart_of_accounts
		return standard_chart_of_accounts.get()
	elif chart_template == "Standard with Numbers":
		from erpadda.accounts.doctype.account.chart_of_accounts.verified \
...
def get_account_tree_from_existing_company(existing_company):
	all_accounts = vmraid.get_all('Account',

...
vmraid.ui.form.on('Hotel Room Package', {
	hotel_room_type: function(frm) {
		if (frm.doc.hotel_room_type) {
			vmraid.model.with_doc('Hotel Room Type', frm.doc.hotel_room_type, () => {
				let hotel_room_type = vmraid.get_doc('Hotel Room Type', frm.doc.hotel_room_type);

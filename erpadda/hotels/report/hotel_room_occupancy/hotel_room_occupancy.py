...
from vmraid.utils import add_days, date_diff

from erpadda.hotels.doctype.hotel_room_reservation.hotel_room_reservation import get_rooms_booked
...
def get_data(filters):
	out = []
	for room_type in vmraid.get_all('Hotel Room Type'):
		total_booked = 0

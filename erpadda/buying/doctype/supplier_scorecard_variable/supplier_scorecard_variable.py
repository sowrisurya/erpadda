...
class VariablePathNotFound(vmraid.ValidationError): pass
...
class SupplierScorecardVariable(Document):
	...
	def validate_path_exists(self):
		if '.' in self.path:
			try:
				from erpadda.buying.doctype.supplier_scorecard_period.supplier_scorecard_period import import_string_path

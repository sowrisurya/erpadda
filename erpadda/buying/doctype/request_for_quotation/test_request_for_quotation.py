...
from erpadda.buying.doctype.request_for_quotation.request_for_quotation import make_supplier_quotation_from_rfq
from erpadda.buying.doctype.request_for_quotation.request_for_quotation import create_supplier_quotation
...
class TestRequestforQuotation(unittest.TestCase):
	...
	def test_make_supplier_quotation_with_special_characters(self):
		...
		vmraid.form_dict = vmraid.local("form_dict")

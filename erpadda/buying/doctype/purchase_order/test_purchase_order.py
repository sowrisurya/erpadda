...
from vmraid.utils import flt, add_days, nowdate, getdate
...
from erpadda.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_invoice as make_pi_from_pr
...
from erpadda.controllers.buying_controller import get_backflushed_subcontracted_raw_materials
...
class TestPurchaseOrder(unittest.TestCase):
	...
	def test_update_child_removing_item(self):
		...
		self.assertRaises(vmraid.ValidationError, update_child_qty_rate, 'Purchase Order', trans_item, po.name)
	...
	def test_update_child_with_tax_template(self):
		...
		if not vmraid.db.exists("Item Tax",
	...
	def test_return_against_purchase_order(self):
		...
		from erpadda.stock.doctype.purchase_receipt.test_purchase_receipt \
				import make_purchase_receipt as make_purchase_receipt_return
		from erpadda.accounts.doctype.purchase_invoice.test_purchase_invoice \
	...
	def test_po_for_blocked_supplier_payments(self):
		...
		self.assertRaises(
			vmraid.ValidationError, get_payment_entry, dt='Purchase Order', dn=po.name, bank_account="_Test Bank - _TC")

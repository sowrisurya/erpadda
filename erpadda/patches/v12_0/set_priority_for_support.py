...
def set_priorities_service_level():
	...
	try:
		service_level_priorities = vmraid.get_list("Service Level", fields=["name", "priority", "response_time", "response_time_period", "resolution_time", "resolution_time_period"])
...
def set_priorities_service_level_agreement():
	...
	try:
		service_level_agreement_priorities = vmraid.get_list("Service Level Agreement", fields=["name", "priority", "response_time", "response_time_period", "resolution_time", "resolution_time_period"])

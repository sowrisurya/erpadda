...
def create_stock_entry_types():
	...
	vmraid.db.sql(" UPDATE `tabStock Entry` set purpose = 'Send to Subcontractor' where purpose = 'Subcontract'")
...
def add_gst_hsn_code_field():
	...
	vmraid.db.sql(""" update `tabStock Entry Detail`, `tabItem`
		SET

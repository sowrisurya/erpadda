...
def delete_custom_field_tax_id_if_exists():
	for field in vmraid.db.sql_list("""select name from `tabCustom Field` where fieldname='tax_id'
...
<p>Thanks,</p>
ERPAdda Team.
	""".format(gst_document_link="<a href='http://vmraid.github.io/erpadda/user/manual/en/regional/india/'> ERPAdda GST Document </a>")

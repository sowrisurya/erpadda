...
from vmraid.utils import getdate, get_time, today
...
def execute():
	for doctype in ('repost_item_valuation', 'stock_entry_detail', 'purchase_receipt_item',
		...
		vmraid.reload_doc('stock', 'doctype', doctype)
	vmraid.reload_doc('buying', 'doctype', 'purchase_receipt_item_supplied')
...
def get_creation_time():
	return vmraid.db.sql(''' SELECT create_time FROM

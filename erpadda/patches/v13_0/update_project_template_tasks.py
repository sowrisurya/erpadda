...
def execute():
	...
	property_setter = vmraid.db.get_value('Property Setter', {'doc_type': 'Task',
		'field_name': 'status', 'property': 'options'})

	if property_setter:
		property_setter_doc = vmraid.get_doc('Property Setter', {'doc_type': 'Task',
			'field_name': 'status', 'property': 'options'})

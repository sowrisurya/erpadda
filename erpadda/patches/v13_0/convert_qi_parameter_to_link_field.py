...
def execute():
	...
	reading_params = vmraid.db.get_all("Quality Inspection Reading", fields=["distinct specification"])
	...
	template_params = vmraid.db.get_all("Item Quality Inspection Parameter", fields=["distinct specification"])

...
def execute():
	...
	modified_items = vmraid.db.sql_list("""
	...
	for doctype in transactions:
		item_warehouses_with_transactions += list(vmraid.db.sql("""
	...
	item_warehouses_with_bin = list(vmraid.db.sql("select distinct item_code, warehouse from `tabBin`"))

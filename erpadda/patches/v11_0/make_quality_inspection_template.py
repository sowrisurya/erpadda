...
def execute():
	...
	for data in vmraid.get_all('Item Quality Inspection Parameter',
		...
		vmraid.db.set_value('Item', data.parent, "quality_inspection_template", qc_doc.name, update_modified=False)
		vmraid.db.sql(""" update `tabItem Quality Inspection Parameter`
	...
	vmraid.db.sql(""" update `tabVariant Field` set field_name = 'quality_inspection_template'

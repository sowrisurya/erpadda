...
$.extend(shopping_cart, {
	show_shoppingcart_dropdown: function() {
		$(".shopping-cart").on('shown.bs.dropdown', function() {
			if (!$('.shopping-cart-menu .cart-container').length) {
				return vmraid.call({
					method: 'erpadda.shopping_cart.cart.get_shopping_cart_menu',
					callback: function(r) {
						if (r.message) {
	...
	update_cart: function(opts) {
		if(vmraid.session.user==="Guest") {
			...
			return vmraid.call({
				type: "POST",
				method: "erpadda.shopping_cart.cart.update_cart",
				args: {
	...
	show_cart_navbar: function () {
		vmraid.call({
			method: "erpadda.shopping_cart.doctype.shopping_cart_settings.shopping_cart_settings.is_cart_enabled",
			callback: function(r) {

...
import vmraid
import unittest
from erpadda.hr.doctype.employee_group.test_employee_group import make_employee_group
...
def create_service_level_agreement(default_service_level_agreement, holiday_list, employee_group,
	...
	service_level_agreement = vmraid.get_doc({
	...
	service_level_agreement_exists = vmraid.db.exists("Service Level Agreement", filters)

	if not service_level_agreement_exists:
		service_level_agreement.insert(ignore_permissions=True)
		return service_level_agreement
	else:
		return vmraid.get_doc("Service Level Agreement", service_level_agreement_exists)

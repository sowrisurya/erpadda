class ItemConfigure {
	...
	get_next_attribute_and_values(selected_attributes) {
		return this.call('erpadda.portal.product_configurator.utils.get_next_attribute_and_values', {
	...
	get_attributes_and_values() {
		return this.call('erpadda.portal.product_configurator.utils.get_attributes_and_values', {
			item_code: this.item_code
		});
	}

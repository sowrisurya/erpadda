...
var shopping_cart = erpadda.shopping_cart;
...
$.extend(shopping_cart, {
	...
	get_update_address_dialog() {
		let d = new vmraid.ui.Dialog({
			...
			primary_action: () => {
				...
				vmraid.call({
					type: "POST",
					method: "erpadda.shopping_cart.cart.update_cart_address",
					freeze: true,
					args: {
						address_type,
						address_name
	...
	apply_shipping_rule: function(rule, btn) {
		return vmraid.call({
			btn: btn,
			type: "POST",
			method: "erpadda.shopping_cart.cart.apply_shipping_rule",
	...
	place_order: function(btn) {
		return vmraid.call({
			type: "POST",
			method: "erpadda.shopping_cart.cart.place_order",
			btn: btn,
			callback: function(r) {
				if(r.exc) {
					var msg = "";
	...
	request_quotation: function(btn) {
		return vmraid.call({
			type: "POST",
			method: "erpadda.shopping_cart.cart.request_for_quotation",
			btn: btn,
			callback: function(r) {
				if(r.exc) {
					var msg = "";
	...
	apply_coupon_code: function(btn) {
		return vmraid.call({
			type: "POST",
			method: "erpadda.shopping_cart.cart.apply_coupon_code",
			btn: btn,
			args : {

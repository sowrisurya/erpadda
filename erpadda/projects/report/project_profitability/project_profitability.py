...
def get_rows(filters):
	...
	if not standard_working_hours:
		msg = _("The metrics for this report are calculated based on the Standard Working Hours. Please set {0} in {1}.").format(
			vmraid.bold("Standard Working Hours"), vmraid.utils.get_link_to_form("HR Settings", "HR Settings"))
...
def get_conditions(filters):
	...
	if filters.get("project"):
		conditions.append("tabTimesheet.parent_project={0}".format(vmraid.db.escape(filters.get("project"))))

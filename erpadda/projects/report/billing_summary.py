...
from vmraid.utils import time_diff_in_hours, flt
...
def get_data(filters):
	...
	filters.to_date = vmraid.utils.add_to_date(vmraid.utils.get_datetime(filters.to_date), days=1, seconds=-1)
...
def get_timesheets(filters):
	...
	timesheets = vmraid.get_all("Timesheet", filters=record_filters, fields=["employee", "employee_name", "name"])

...
from vmraid.utils import now_datetime, nowdate, add_days, add_months
...
from erpadda.payroll.doctype.salary_structure.test_salary_structure \
...
def make_salary_structure_for_timesheet(employee, company=None):
	...
	if not vmraid.db.get_value("Salary Structure Assignment",
		{'employee':employee, 'docstatus': 1}):
			vmraid.db.set_value('Employee', employee, 'date_of_joining',

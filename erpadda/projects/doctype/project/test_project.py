...
class TestProject(unittest.TestCase):
	def test_project_with_template_having_no_parent_and_depend_tasks(self):
		...
		tasks = vmraid.get_all('Task', ['subject','exp_end_date','depends_on_tasks'], dict(project=project.name), order_by='creation asc')
	...
	def test_project_template_having_parent_child_tasks(self):
		...
		project = get_project(project_name, template)
		tasks = vmraid.get_all('Task', ['subject','exp_end_date','depends_on_tasks', 'name', 'parent_task'], dict(project=project.name), order_by='creation asc')
	...
	def test_project_template_having_dependent_tasks(self):
		...
		project = get_project(project_name, template)
		tasks = vmraid.get_all('Task', ['subject','exp_end_date','depends_on_tasks', 'name'], dict(project=project.name), order_by='creation asc')

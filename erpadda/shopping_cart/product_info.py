...
import vmraid
from erpadda.shopping_cart.cart import _get_cart_quotation, _set_price_list
from erpadda.shopping_cart.doctype.shopping_cart_settings.shopping_cart_settings \
	import get_shopping_cart_settings, show_quantity_in_website
from erpadda.utilities.product import get_price, get_qty_in_stock, get_non_stock_item_status

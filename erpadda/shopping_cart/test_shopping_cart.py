...
from erpadda.shopping_cart.cart import _get_cart_quotation, update_cart, get_party
...
class TestShoppingCart(unittest.TestCase):
	...
	def create_tax_rule(self):
		...
		try:
			vmraid.get_doc(tax_rule).insert()
	...
	def enable_shopping_cart(self):
		settings = vmraid.get_doc("Shopping Cart Settings", "Shopping Cart Settings")
		...
		# insert item price
		if not vmraid.db.get_value("Item Price", {"price_list":  "_Test Price List India",
			"item_code": "_Test Item"}):
			vmraid.get_doc({
				"doctype": "Item Price",
				"price_list": "_Test Price List India",
	...
	def clear_existing_quotations(self):
		quotations = vmraid.get_all("Quotation", filters={

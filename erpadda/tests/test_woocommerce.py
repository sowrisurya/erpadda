...
def emulate_request():
	...
	url = "http://{site}:{port}/api/method/erpadda.erpadda_integrations.connectors.woocommerce_connection.order".format(site=host, port=port)

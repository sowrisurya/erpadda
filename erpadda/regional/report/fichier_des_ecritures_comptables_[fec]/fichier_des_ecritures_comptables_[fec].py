...
def get_result_as_list(data, filters):
	...
	accounts = vmraid.get_all("Account", filters={"Company": filters.company}, fields=["name", "account_number"])
	...
	for d in data:
		...
		if account_number[0] is not None:
			...
			vmraid.throw(_("Account number for account {0} is not available.<br> Please setup your Chart of Accounts correctly.").format(d.get("account")))

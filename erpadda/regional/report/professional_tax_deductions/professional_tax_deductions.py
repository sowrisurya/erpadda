...
from erpadda.regional.report.provident_fund_deductions.provident_fund_deductions import get_conditions
...
def get_data(filters):
	...
	entry = vmraid.db.sql(""" select sal.employee, sal.employee_name, ded.salary_component, ded.amount

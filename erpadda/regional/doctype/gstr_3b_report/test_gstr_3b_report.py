...
class TestGSTR3BReport(unittest.TestCase):
	...
	def test_gstr_3b_report(self):
		...
		if vmraid.db.exists("GSTR 3B Report", "GSTR3B-March-2019-_Test Address-Billing"):
			report = vmraid.get_doc("GSTR 3B Report", "GSTR3B-March-2019-_Test Address-Billing")
			report.save()
		else:
...
def make_company():
	...
	if not vmraid.db.exists('Address', '_Test Address-Billing'):
		address = vmraid.get_doc({
			"address_line1": "_Test Address Line 1",

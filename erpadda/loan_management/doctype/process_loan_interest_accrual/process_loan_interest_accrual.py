...
from erpadda.loan_management.doctype.loan_interest_accrual.loan_interest_accrual import (make_accrual_interest_entry_for_demand_loans,
...
def term_loan_accrual_pending(date):
	pending_accrual = vmraid.db.get_value('Repayment Schedule', {
		'payment_date': ('<=', date),
		'is_accrued': 0
	})

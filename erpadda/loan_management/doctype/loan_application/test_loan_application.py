...
import vmraid
import unittest
from erpadda.payroll.doctype.salary_structure.test_salary_structure import make_employee, make_salary_structure
from erpadda.loan_management.doctype.loan.test_loan import create_loan_type, create_loan_accounts

...
class TestRestaurantMenu(unittest.TestCase):
	def test_price_list_creation_and_editing(self):
		menu1 = vmraid.get_doc('Restaurant Menu', 'Test Restaurant 1 Menu 1')
		menu1.save()

		menu2 = vmraid.get_doc('Restaurant Menu', 'Test Restaurant 1 Menu 2')
		menu2.save()

		self.assertTrue(vmraid.db.get_value('Price List', 'Test Restaurant 1 Menu 1'))

...
def execute(filters=None):
	...
	for student in absent_students:
		if not student.student in leave_applicants:
			...
			stud_details = vmraid.db.get_value("Student", student.student, ['student_email_id', 'student_mobile_number'], as_dict=True)
...
def get_transportation_details(date, student_list):
	academic_year = vmraid.get_all("Academic Year", filters=[["year_start_date", "<=", date],["year_end_date", ">=", date]])
	if academic_year:
	...
	transportation_details = vmraid.get_all("Program Enrollment", fields=["student", "mode_of_transportation", "vehicle_no"],

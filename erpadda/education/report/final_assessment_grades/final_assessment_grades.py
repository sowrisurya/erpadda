...
from erpadda.education.report.course_wise_assessment_report.course_wise_assessment_report import get_chart_data
...
def execute(filters=None):
	...
	args.students = vmraid.db.sql_list("select student from `tabStudent Group Student` where parent=%s", (student_group))

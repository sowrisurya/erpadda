...
from erpadda.education.doctype.course.test_course import make_course
...
class TestStudent(unittest.TestCase):
	...
	def test_enroll_in_program(self):
		...
		test_enrollment = vmraid.get_all("Program Enrollment", filters={"student": student.name, "Program": "_Test Program 1"})

...
from vmraid.utils import cstr, today, flt, add_years, formatdate, getdate
from erpadda.accounts.report.financial_statements import get_period_list, get_fiscal_year_data, validate_fiscal_year
...
def prepare_chart_data(data, filters):
	...
	for d in period_list:
		labels_values_map.setdefault(d.get('label'), vmraid._dict({'asset_value': 0, 'depreciated_amount': 0}))
...
def get_finance_book_value_map(filters):
	...
	return vmraid._dict(vmraid.db.sql(''' Select

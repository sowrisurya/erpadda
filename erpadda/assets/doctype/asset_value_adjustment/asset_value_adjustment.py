...
from vmraid.utils import flt, getdate, cint, date_diff, formatdate
...
class AssetValueAdjustment(Document):
	...
	def validate_date(self):
		...
		if getdate(self.date) < getdate(asset_purchase_date):
			vmraid.throw(_("Asset Value Adjustment cannot be posted before Asset's purchase date <b>{0}</b>.")

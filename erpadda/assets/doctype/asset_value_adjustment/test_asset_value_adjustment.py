...
import vmraid
import unittest
from vmraid.utils import nowdate, get_last_day, add_days
...
from erpadda.assets.doctype.asset_value_adjustment.asset_value_adjustment import get_current_asset_value

...
class AssetMaintenance(Document):
	...
	def sync_maintenance_tasks(self):
		...
		asset_maintenance_logs = vmraid.get_all("Asset Maintenance Log", fields=["name"], filters = {"asset_maintenance": self.name,
...
def assign_tasks(asset_maintenance_name, assign_to_member, maintenance_task, next_due_date):
	...
	if not vmraid.db.sql("""select owner from `tabToDo`
...
def update_maintenance_log(asset_maintenance, item_code, item_name, task):
	asset_maintenance_log = vmraid.get_value("Asset Maintenance Log", {"asset_maintenance": asset_maintenance,
...
def get_team_members(doctype, txt, searchfield, start, page_len, filters):
	return vmraid.db.get_values('Maintenance Team Member', { 'parent': filters.get("maintenance_team") }, "team_member")

...
import unittest
import vmraid
from vmraid.utils import flt, now, add_months, cint, today, add_to_date
...
class TestWorkOrder(unittest.TestCase):
	...
	def check_planned_qty(self):
		...
		planned0 = vmraid.db.get_value("Bin", {"item_code": "_Test FG Item",
			"warehouse": "_Test Warehouse 1 - _TC"}, "planned_qty") or 0

		wo_order = make_wo_order_test_record()

		planned1 = vmraid.db.get_value("Bin", {"item_code": "_Test FG Item",
		...
		planned2 = vmraid.db.get_value("Bin", {"item_code": "_Test FG Item",
			"warehouse": "_Test Warehouse 1 - _TC"}, "planned_qty")
	...
	def test_reserved_qty_for_production_on_stock_entry(self):
		...
		s = vmraid.get_doc(make_stock_entry(self.wo_order.name,
	...
	def test_scrap_material_qty(self):
		...
		wo_order_details = vmraid.db.get_value("Work Order", wo_order.name,
	...
	def test_job_card(self):
		...
		job_cards = vmraid.get_all('Job Card', filters = {'work_order': work_order.name})
	...
	def test_capcity_planning(self):
		vmraid.db.set_value("Manufacturing Settings", None, {
			"disable_capacity_planning": 0,
			"capacity_planning_for_days": 1
		})

		data = vmraid.get_cached_value('BOM', {'docstatus': 1, 'item': '_Test FG Item 2',
	...
	def test_operation_time_with_batch_size(self):
		...
		bom_name = vmraid.db.get_value("BOM",
	...
	def test_extra_material_transfer(self):
		vmraid.db.set_value("Manufacturing Settings", None, "material_consumption", 0)
		vmraid.db.set_value("Manufacturing Settings", None, "backflush_raw_materials_based_on",
	...
	def test_valuation_rate_missing_on_make_stock_entry(self):
		...
		self.assertRaises(vmraid.ValidationError, make_stock_entry, wo.name, 'Material Transfer for Manufacture')

def get_scrap_item_details(bom_no):
	scrap_items = {}
	for item in vmraid.db.sql("""select item_code, stock_qty from `tabBOM Scrap Item`
...
def make_wo_order_test_record(**args):
	...
	wo_order.bom_no = args.bom_no or vmraid.db.get_value("BOM", {"item": wo_order.production_item,

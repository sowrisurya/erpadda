...
class TestBOM(unittest.TestCase):
	...
	def test_update_bom_cost_in_all_boms(self):
		...
		rm_rate = vmraid.db.sql("""select rate from `tabBOM Item`
		...
		for d in vmraid.db.sql("""select rate from `tabBOM Item`
	...
	def test_bom_cost_multi_uom_multi_currency_based_on_price_list(self):
		...
		for item_code, rate in (("_Test Item", 3600), ("_Test Item Home Desktop Manufactured", 3000)):
			vmraid.db.sql("delete from `tabItem Price` where price_list='_Test Price List' and item_code=%s",
				item_code)
	...
	def test_bom_cost_multi_uom_based_on_valuation_rate(self):
		...
		reset_item_valuation_rate(
			...
			warehouse_list=vmraid.get_all("Warehouse",

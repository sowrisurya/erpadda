...
class ProductionPlanReport(object):
	...
	def get_open_orders(self):
		...
		self.orders = vmraid.db.sql(""" SELECT {fields} from {doctype}
	...
	def get_raw_materials(self):
		...
		if self.filters.based_on == "Work Order":
			...
			raw_materials = vmraid.get_all("Work Order Item",
			...
			raw_materials = vmraid.db.sql(""" SELECT bom_item.parent, bom_item.item_code,
	...
	def get_item_details(self):
		...
		self.item_details = {}
		for d in vmraid.get_all("Item Default", fields = ["parent", "default_warehouse"],
	...
	def get_purchase_details(self):
		...
		for d in vmraid.get_all("Purchase Order Item",

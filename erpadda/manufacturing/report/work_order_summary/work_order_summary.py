...
import vmraid
from vmraid.utils import date_diff, today, getdate, flt
from vmraid import _
from erpadda.stock.report.stock_analytics.stock_analytics import (get_period_date_ranges, get_period)
...
def get_data(filters):
	...
	data = vmraid.get_all("Work Order",

...
def get_data(filters=None):
	...
	item_stock_map = vmraid.get_all("Bin", fields=["item_code", "sum(actual_qty) AS available"], group_by="item_code")
...
def get_selling_items(filters):
	...
	items = vmraid.get_all("Item", filters=item_filters, fields=["item_code", "item_name"], order_by="item_name")

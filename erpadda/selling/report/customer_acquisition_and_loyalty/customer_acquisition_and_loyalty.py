...
def get_data_by_territory(filters, common_columns):
	...
	territory_dict = {}
	for t in vmraid.db.sql('''SELECT name, lft, parent_territory, is_group FROM `tabTerritory` ORDER BY lft''', as_dict=1):
...
def get_customer_stats(filters, tree_view=False):
	...
	for si in vmraid.db.sql('''select territory, posting_date, customer, base_grand_total from `tabSales Invoice`

...
def get_customer_details():
	details = vmraid.get_all("Customer",
		fields=["name", "customer_name", "customer_group"])
	customer_details = {}
	for d in details:
		customer_details.setdefault(d.name, vmraid._dict({
...
def get_item_details():
	details = vmraid.db.get_all("Item",
		fields=["item_code", "item_name", "item_group"])
	item_details = {}
	for d in details:
		item_details.setdefault(d.item_code, vmraid._dict({

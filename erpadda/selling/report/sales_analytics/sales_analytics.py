...
from vmraid.utils import getdate, flt, add_to_date, add_days
...
class Analytics(object):
	...
	def get_sales_transactions_based_on_order_type(self):
		...
		self.entries = vmraid.db.sql(""" select s.order_type as entity, s.{value_field} as value_field, s.{date_field}
	...
	def get_sales_transactions_based_on_customers_or_suppliers(self):
		...
		self.entries = vmraid.get_all(self.filters.doc_type,
	...
	def get_groups(self):
		...
		self.group_entries = vmraid.db.sql("""select name, lft, rgt , {parent} as parent
	...
	def get_teams(self):
		...
		self.group_entries = vmraid.db.sql(""" select * from (select "Order Types" as name, 0 as lft,
	...
	def get_supplier_parent_child_map(self):
		self.parent_child_map = vmraid._dict(vmraid.db.sql(""" select name, supplier_group from `tabSupplier`"""))

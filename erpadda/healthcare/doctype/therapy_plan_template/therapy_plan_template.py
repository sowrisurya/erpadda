...
from erpadda.healthcare.doctype.therapy_type.therapy_type import make_item_price
...
class TherapyPlanTemplate(Document):
	...
	def update_item(self):
		item_doc = vmraid.get_doc('Item', {'item_code': self.linked_item})
	...
	def update_item_price(self):
		item_price = vmraid.get_doc('Item Price', {'item_code': self.linked_item})

...
vmraid.ui.form.on('Therapy Plan', {
	setup: function(frm) {
			...
			if (frm.doc.status != 'Completed') {
				...
				frm.add_custom_button(__('Therapy Session'), function() {
					vmraid.prompt(fields, data => {
						vmraid.call({
							method: 'erpadda.healthcare.doctype.therapy_plan.therapy_plan.make_therapy_session',
							args: {
	...
	make_sales_invoice: function(frm) {
		vmraid.call({
			...
			method: 'erpadda.healthcare.doctype.therapy_plan.therapy_plan.make_sales_invoice',
			callback: function(r) {
...
vmraid.ui.form.on('Therapy Plan Detail', {

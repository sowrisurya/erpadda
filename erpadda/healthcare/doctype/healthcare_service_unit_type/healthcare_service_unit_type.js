...
vmraid.ui.form.on('Healthcare Service Unit Type', {
...
let change_item_code = function(frm, doc) {
	let d = new vmraid.ui.Dialog({
		...
		primary_action: function() {
			...
			if (values) {
				vmraid.call({
					"method": "erpadda.healthcare.doctype.healthcare_service_unit_type.healthcare_service_unit_type.change_item_code",

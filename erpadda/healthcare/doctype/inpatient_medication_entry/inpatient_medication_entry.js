...
vmraid.ui.form.on('Inpatient Medication Entry', {
	refresh: function(frm) {
		...
		frm.add_custom_button(__('Make Stock Entry'), function() {
			vmraid.call({
				method: 'erpadda.healthcare.doctype.inpatient_medication_entry.inpatient_medication_entry.make_difference_stock_entry',

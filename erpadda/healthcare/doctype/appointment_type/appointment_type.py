	...
	def validate(self):
		if self.items and self.price_list:
			for item in self.items:
				existing_op_item_price = vmraid.db.exists('Item Price', {
				...
				existing_ip_item_price = vmraid.db.exists('Item Price', {
...
def get_service_item_based_on_department(appointment_type, department):
	item_list = vmraid.db.get_value('Appointment Type Service Item',

...
vmraid.ui.form.on('Clinical Procedure', {
	setup: function(frm) {
		frm.set_query('batch_no', 'items', function(doc, cdt, cdn) {
			...
			if (!item.item_code) {
				...
				if (frm.doc.status == 'In Progress') {
					filters['posting_date'] = frm.doc.start_date || vmraid.datetime.nowdate();
	...
	practitioner: function(frm) {
		if (frm.doc.practitioner) {
			vmraid.call({
				...
				callback: function (data) {
					vmraid.model.set_value(frm.doctype,frm.docname, 'practitioner_name', data.message.practitioner_name);
				}
			});
		} else {
			vmraid.model.set_value(frm.doctype,frm.docname, 'practitioner_name', '');
		}
	},
	...
	set_procedure_consumables: function(frm) {
		vmraid.call({
			method: 'erpadda.healthcare.doctype.clinical_procedure.clinical_procedure.get_procedure_consumables',
			args: {

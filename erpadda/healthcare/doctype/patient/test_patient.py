...
class TestPatient(unittest.TestCase):
	def test_customer_created(self):
		...
		vmraid.db.set_value('Healthcare Settings', None, 'link_customer_to_patient', 1)
		patient = create_patient()
		self.assertTrue(vmraid.db.get_value('Patient', patient, 'customer'))
	...
	def test_patient_registration(self):
		...
		self.assertTrue(vmraid.db.exists('Sales Invoice', result.get('invoice')))

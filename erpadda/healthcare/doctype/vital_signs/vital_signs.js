...
let calculate_bmi = function(frm){
	...
	vmraid.model.set_value(frm.doctype,frm.docname, 'bmi', bmi);
	vmraid.model.set_value(frm.doctype,frm.docname, 'nutrition_note', bmi_note);
};

let set_bp = function(frm){
	let bp = frm.doc.bp_systolic+ '/' + frm.doc.bp_diastolic + ' mmHg';
	vmraid.model.set_value(frm.doctype,frm.docname, 'bp', bp);
};

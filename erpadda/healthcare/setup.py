...
def setup_healthcare():
	if vmraid.db.exists('Medical Department', 'Cardiology'):
		# already setup
		return
...
def create_medical_departments():
	...
	for department in departments:
		mediacal_department = vmraid.new_doc("Medical Department")
...
def create_antibiotics():
	...
	for a in abt:
		antibiotic = vmraid.new_doc("Antibiotic")
...
def get_company():
	...
	if company:
		...
		company = vmraid.get_list("Company", limit=1)
		if company:

...
def get_data(filters):
	...
	if erpadda.get_region() == "India":
		employee_pan_dict = vmraid._dict(vmraid.db.sql(""" select employee, pan_number from `tabEmployee`"""))

	component_types = vmraid.db.sql(""" select name from `tabSalary Component`
	...
	entry = vmraid.db.sql(""" select sal.employee, sal.employee_name, sal.posting_date, ded.salary_component, ded.amount,sal.gross_pay
